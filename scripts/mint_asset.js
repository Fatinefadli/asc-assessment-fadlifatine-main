...
async function run(runtimeEnv, deployer) {
    ...
    deployer.addCheckpointKV('holdingsAppID',app1.appID)
    deployer.addCheckpointKV('holdingsAppAddress',app1.applicationAccount)
    ...
    await executeTransaction(deployer, {
        ...
        appArgs: ["save"].map(convert.stringToBytes),
    });
